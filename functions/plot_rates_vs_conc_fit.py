...
def plot_rates_vs_conc_fit(smoothed_df, rates_df, param_df, compound='phe'):
    ...
    for _, row in param_df.iterrows():
        ...
        plt.scatter(smoothed_concs, smoothed_rates, marker=marker, color=color, linewidth=.5, s=20, label=trial)
